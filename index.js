...
const statusMessages = [
  ...
  { name: "Watching Anime with Kami", type: ActivityType.WATCHING },
  { name: "Fixing Felix's server", type: ActivityType.WATCHING }
];

let currentIndex = 0;
const channelId = '1200924465702383687'; // Replace with your actual text channel ID
